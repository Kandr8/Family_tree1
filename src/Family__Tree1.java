...
public class Family__Tree1
//    Атрибуты древа: номер человека(счет),список,
    <T extends TreeTop>   implements  Iterable<T>, Serializable{
private List<T> list;
private String family;


public Family__tree1(String family){
        list = new ArrayList<>();
        this.family = family;
        }
...
public void save(String path){
    ...
    public Family_tree1(String family){
            list = new ArrayList<>();
            this.family = family;
        }
